...
class ProportyStatus(models.Model):
...
class PropertySiteInherit(models.Model):
    ...
    property_status=fields.Many2one('property.status',string="Status")
    ...
    def create(self, vals):
        ...
        if 'floor_ids' in vals:
            ...
            for floor_id in floor_ids:
                ...
                property_name = f"{site.name}-{floor_name}-{block.name}-{pro_type.property_type_id.code}"
